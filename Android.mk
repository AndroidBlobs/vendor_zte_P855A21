...
LOCAL_MODULE_OWNER := zte
LOCAL_SRC_FILES := proprietary/priv-app/SoterService/SoterService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := ThermalBridge
LOCAL_MODULE_OWNER := zte
LOCAL_SRC_FILES := proprietary/vendor/app/ThermalBridge/ThermalBridge.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
